...
api_url = "https://anonymouspwplayerr-f996115ea61a.herokuapp.com/pw?url=%7Burl%7D&token=%7Bpw_token%7D"
...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/dhairya_bh"),
            InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/dhairya_bh"),
        ],
    ]
)
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [{CREDIT}](https://t.me/dhairya_bh)\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                url = f"https://scammer-keys.vercel.app/api?url={url}&token={cptoken}&auth=@Dhairya_bh"
